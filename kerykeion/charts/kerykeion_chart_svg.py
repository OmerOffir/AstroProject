...
class KerykeionChartSVG:
    ...
    def __init__(
        ...
        if new_output_directory:
            ...
            self.output_directory = Path(r"F:\Astro_db")
...
if __name__ == "__main__":
    ...
    internal_natal_chart = KerykeionChartSVG(first, theme="dark-high-contrast")
    svg_path = internal_natal_chart.makeSVG()
    internal_natal_chart.capture_svg_screenshot(svg_path)
